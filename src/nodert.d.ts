declare module '@nodert-win10-rs3/windows.devices.geolocation' {
  ...
  export class Geolocator {
    ...
    static requestAccessAsync(
      callback: (
        error: Error,
        result: GeolocationAccessStatus
      ) => void
    ): void;
    ...
    getGeopositionAsync(
      callback: (error: Error, result: Geoposition) => void
    ): void;
    getGeopositionAsync(
      maximumAge: number,
      timeout: number,
  ...
  export class GeovisitMonitor {
    ...
    static getLastReportAsync(
      callback: (error: Error, result: Geovisit) => void
    ): void;
